...
/**
 * Provides the local service interface for stickyNote. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author mbelda
 * @see stickyNoteLocalServiceUtil
...
public interface stickyNoteLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link stickyNoteLocalServiceUtil} to access the sticky note local service. Add custom service methods to {@link com.stickynotes.service.impl.stickyNoteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
