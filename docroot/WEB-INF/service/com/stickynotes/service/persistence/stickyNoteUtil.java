...
public class stickyNoteUtil {
	 ...
	 */
	public static stickyNote update(stickyNote stickyNote, boolean merge)
		throws SystemException {
		return getPersistence().update(stickyNote, merge);
	}
	...
	public static stickyNote update(stickyNote stickyNote, boolean merge,
		...
		return getPersistence().update(stickyNote, merge, serviceContext);
	}
	...
	*/
	...
	public static com.stickynotes.model.stickyNote updateImpl(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(stickyNote, merge);
	}
