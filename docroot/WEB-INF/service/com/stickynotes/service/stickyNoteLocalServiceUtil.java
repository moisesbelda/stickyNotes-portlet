...
/**
 * The utility for the sticky note local service. This utility wraps {@link com.stickynotes.service.impl.stickyNoteLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class stickyNoteLocalServiceUtil {
	...
	*/
	public static com.stickynotes.model.stickyNote updatestickyNote(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updatestickyNote(stickyNote, merge);
	}
